...
class BaseModel(pl.LightningModule):
    """
    Lightning module for transformer-based URL classification.
    Optimized for malicious URL detection using DomURLs_BERT and URLBert models.
    
    Args:
        classifier (nn.module): transformer-based classifier
        ...
        names: classes names for URL classification tasks
    """
